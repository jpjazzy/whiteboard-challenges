[null, true, or false] = whiteboardFn.checkLL(linked list) 
    -Takes in a linked list and returns a null (invalid or not a linked list to test), true (is circular linked list), false ( is not a circular linked list)
